...
export async function POST(
  ...
  // Fire on a reaction *set* (not clear). Notes are now uniformly
  // private (the public board was retired in 2026-05) and the author
  // sees the reaction on their own /desk past-notes view, so the
  // bell ping points them there. Best-effort write.
